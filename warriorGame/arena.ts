...
export class Arena{
    public activeWarrior: ActiveWarrior = ActiveWarrior.Second;
    ...
    fight(): Warrior | null {
        const attacker: Warrior = this.activeWarrior === ActiveWarrior.First ? this.warrior1 : this.warrior2;
        const attacked: Warrior = this.activeWarrior === ActiveWarrior.First ? this.warrior2 : this.warrior1;
